...
use Drupal\penn_api_entity\Entity\PennApiEntity;


/**
 * Provides dynamic permissions for Penn API Entity of different types.
 *
 * @ingroup penn_api_entity
 *
 */
class PennApiEntityPermissions{
   ...
   *
   * @return array
   *   The PennApiEntity by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (PennApiEntity::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\penn_api_entity\Entity\PennApiEntity $type
   *   The PennApiEntity type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(PennApiEntity $type) {
    $type_id = $type->id();
