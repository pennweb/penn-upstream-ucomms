...
/**
 * Provides a form for reverting a Penn API Entity revision for a single trans.
 *
 * @ingroup penn_api_entity
 */
class PennApiEntityRevisionRevertTranslationForm extends PennApiEntityRevisionRevertForm {
  ...
  public function getFormId() {
    return 'penn_api_entity_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $penn_api_entity_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $penn_api_entity_revision);
