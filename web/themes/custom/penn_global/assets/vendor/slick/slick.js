...
; (function (factory) {
	...
	Slick.prototype.changeSlide = function (event, dontAnimate) {
		...
		//Dan
		//Set window scrollposition to do after scroll.
		localStorage.setItem('bodyPosition', window.pageYOffset);
		...
		if (!_.unslicked) {
			...
			if (_.options.accessibility === true) {
				...
				if (_.options.focusOnChange) {
					...
					if (_.focussed) {
						var sliderPosition = localStorage.getItem('bodyPosition');
						$currentSlide.focus();
						if (sliderPosition !== null) {

							var oldPosition = parseInt(sliderPosition, 10);
				...
				localStorage.removeItem('bodyPosition');
			}
